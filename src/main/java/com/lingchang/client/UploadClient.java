...
public class UploadClient {
    ...
    public void uploadFile(String path) {
        ...
        try {
            HttpRequest request = new DefaultHttpRequest(HTTP_1_1, HttpMethod.POST, "");
            ...
            HttpRequest request2 = new DefaultHttpRequest(HTTP_1_1, HttpMethod.POST, file.getName());
